...
from hookbook.settings import AUTH_USER_MODEL
...
class Assignment(models.Model):
    teacher = models.ForeignKey(
        AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="created_assignments"
    )
    textcontent = models.ForeignKey(
        TextContent, on_delete=models.CASCADE, related_name="assignments"
    )
...
class Sentence(models.Model):
    paragraph = models.ForeignKey(
        Paragraph, on_delete=models.CASCADE, null=True, related_name="sentences"
    )
...
class StudentAssignment(models.Model):
    ...
    student = models.ForeignKey(
        AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="assignments"
    )
    textcontent = models.ForeignKey(
        TextContent, on_delete=models.CASCADE, related_name="student_assignments"
    )
    ...
    current_sentence = models.ForeignKey(
        Sentence,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="current_for_assignments",
    )
...
class Support(models.Model):
    paragraph = models.ForeignKey(
        Paragraph, on_delete=models.CASCADE, null=True, related_name="supports"
    )
...
class EnrichmentTemplate(models.Model):
    textcontent = models.ForeignKey(
        TextContent, on_delete=models.CASCADE, related_name="%(class)ss"
    )
    content = models.CharField(max_length=1000)
    explanation = models.TextField()
    reference_sentence = models.ForeignKey(
        Sentence, on_delete=models.SET_NULL, null=True, related_name="%(class)ss"
    )
...
class Question(models.Model):
    ...
    textcontent = models.ForeignKey(
        TextContent, on_delete=models.CASCADE, null=True, related_name="questions"
    )
    ...
    category = models.CharField(
        max_length=20, choices=CATEGORY_CHOICES, default="remember"
    )
    opinion = models.BooleanField(default=False)
    reference_sentence = models.ForeignKey(
        Sentence, on_delete=models.SET_NULL, null=True, related_name="questions"
    )


class QuestionMessage(models.Model):
    question = models.ForeignKey(
        Question, on_delete=models.CASCADE, null=True, related_name="question_messages"
    )
...
class Enrichment(models.Model):
    ...
    sentence = models.ForeignKey(
        Sentence, on_delete=models.CASCADE, related_name="enrichments", default=None
    )
    ...
    enrichment_type = models.CharField(
        max_length=20, choices=ENRICHMENT_TYPES, default="explanation"
    )
...
class EnrichmentMode(models.Model):
    enrichment = models.ForeignKey(
        Enrichment, on_delete=models.CASCADE, related_name="modes"
    )
...
class EnrichmentMessage(models.Model):
    enrichment = models.ForeignKey(
        Enrichment, on_delete=models.CASCADE, related_name="messages"
    )
    ...
    mode = models.ForeignKey(
        EnrichmentMode, on_delete=models.CASCADE, related_name="messages", null=True
    )
