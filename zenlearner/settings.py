"""
Django settings for HookBook project.
...
WSGI_APPLICATION = "hookbook.wsgi.application"
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "hookbook_language"
LANGUAGES = [
...
WAGTAILADMIN_BASE_URL = "http://hookbook.com"
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("HookBook"),
    "URL": "http://hookbook.com",
...
LOGGING = {
    ...
    "loggers": {
        ...
        "hookbook": {
            "handlers": ["console"],
            "level": env("HOOKBOOK_LOG_LEVEL", default="INFO"),
        },
    },
}
