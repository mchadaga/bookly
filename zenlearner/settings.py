"""
Django settings for ZenLearner project.
...
SECRET_KEY = env('SECRET_KEY', default='yNxOKqKGCDUswvqTkntFsKqigZoGokRyrWQABAWT')
...
WSGI_APPLICATION = 'zenlearner.wsgi.application'
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'zenlearner_language'
LANGUAGES = [
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'ZenLearner',
    'DESCRIPTION': 'ZenLearner uses AI to solve the attention span problem in K-12 education.',
    'VERSION': '0.1.0',
...
WAGTAILADMIN_BASE_URL = 'http://zenlearner.com'
...
PROJECT_METADATA = {
    'NAME': gettext_lazy('ZenLearner'),
    'URL': 'http://zenlearner.com',
    'DESCRIPTION': gettext_lazy("ZenLearner uses AI to solve the attention span problem in K-12 education."),
...
LOGGING = {
    ...
    'loggers': {
        ...
        'zenlearner': {
            'handlers': ['console'],
            'level': env('ZENLEARNER_LOG_LEVEL', default='INFO'),
        }
    }
}
